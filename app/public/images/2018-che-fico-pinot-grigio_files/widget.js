...
function p(e){return e&&e.__esModule?e:{default:e}}function m(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var v,b={onMessageCB:function(){return v||(v=this.onMessage.bind(this))},onVisibilityChangeCB:function(){var e
...
if(this.updateFrameSettings(m.settingsPayload),v){var b=document.getElementById(s.default.frameDivId),w=p&&p.expanded||"expanded"
...
break
case"notify_frame":var _=m.data,y=document.getElementById(s.default.frameDivId),E=p&&p.open||"fc-open"
...
break
case"resize_frame":var I=document.getElementsByTagName("BODY")[0],k=p&&p.open||"fc-open"
r.default.opened(m.isOpen),r.default.isOpened()?(this.removeScrollEventAndStyleFromWidget(),b.classList.add("h-open-container"),b.classList.add(k),o.default.publish("widget:opened"),I&&I.classList.add("fc-widget-open")):(b.removeAttribute("style"),b.classList.remove("h-open-container"),b.classList.remove(k),o.default.publish("widget:closed"),I&&I.classList.remove("fc-widget-open"))
break
case"toggle_frame":m.show?b.classList.remove("hide"):-1===b.className.trim().indexOf("hide")&&b.classList.add("hide")
break
...
break
case"frame_state_change":var C=document.getElementById(s.default.frameDivId),L=m&&m.data,O=L&&L.frameState,S=a.default.getSettings()&&a.default.getSettings().enabledFeatures
o.default.publish("frame:statechange",m),"initialized"===O&&(a.default.isJWTEnabled()&&a.default.isJWTStrictMode()&&C.classList.add("fc_dn"),this.loadWidget(),S&&-1!==S.indexOf("COBROWSING")&&g.default.init({host:a.default.getHost(),locale:d.default.getProperties().locale})),"loaded"===O&&a.default.loaded(!0),"authenticated"!==O&&"not_authenticated"!==O||a.default.isJWTEnabled()&&a.default.isJWTStrictMode()&&(m.success?C.classList.remove("fc_dn"):304!==m.status&&this.unloadWidget())
break
...
else if(m.success){var M=P&&P.externalId,T=P&&P.restoreId,x=d.default.getExternalId()
x?x===M&&(d.default.setRestoreId(T),this.onUserCreate(m)):this.onUserCreate(m)}else this.onUserCreate(m)
break
...
break
case"set_storage_item":if(i.default.storageAvailable){var A=m.data
A&&A.key&&A.value&&localStorage.setItem(A.key,JSON.stringify(A.value))}break
case"remove_storage_item":if(i.default.storageAvailable){var N=m.data
...
case"get_lsds_item":if(i.default.storageAvailable){var F=m.data,W=F&&F.key
W&&localStorage.getItem(W)}break
case"remove_lsds_item":if(i.default.storageAvailable){var q=m.data,V=q&&q.key
V&&localStorage.removeItem(V)}break
...
break
default:u.default.publish(v,m)}}}},scrollHandlerForPositionCalculation:function(){var e=document.getElementById(s.default.frameDivId),t=document.getElementsByTagName("BODY")[0],n=screen.availHeight,i=.42
...
n.default=b},{"../helpers/modal":1,"../helpers/omni":2,"../obj/constants":7,"../obj/state":8,"../obj/user":9,"./cb":10,"./common/dom":11,"./events":14,"./frame":15,"./msg_handler":18,"./msg_processor":19,"./push_frame":21}],17:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0
...
r.default.send("generate_user_uuid",e)}},track:g.default.track,trackPage:function(e,t){p.default.track({newValue:e,title:t,force:!0})},authenticate:function(e){if(l.default.isJWTEnabled()){var t=function(){b(this,this),l.default.setJWTAuthToken(e),l.default.postMessage({action:"authenticate_user",payload:e})}.bind(this),n=function(n){b(this,this),n&&200===n.status?this.user.update({jwtAuthToken:e}):t()}.bind(this)
